# vue-select ![Current Release](https://img.shields.io/github/release/veebisepad/vue-select.svg?style=flat-square) ![Release Date](https://img.shields.io/github/release-date/veebisepad/vue-select?style=flat-square) ![Bundle Size](https://flat.badgen.net/bundlephobia/min/vue-select) ![Monthly Downloads](https://img.shields.io/npm/dm/vue-select.svg?style=flat-square) [![Coverage Status](https://coveralls.io/repos/github/veebisepad/vue-select/badge.svg?branch=master)](https://coveralls.io/github/veebisepad/vue-select?branch=master) ![MIT License](https://img.shields.io/github/license/veebisepad/vue-select.svg?style=flat-square)
